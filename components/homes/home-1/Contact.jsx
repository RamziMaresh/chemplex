            ...
            <div className="col-lg-10">
              ...
              <h3 className="section-title mb-0">
                <span className="wow charsAnimIn" data-splitting="chars">
                  <AnimatedText text="Feel Free to Contact Us, Get InTouch!" />
                </span>
              </h3>
            </div>
          </div>
      ...
      <div className="row wow fadeInUp" data-wow-delay="0.5s">
        ...
        <div className="col-md-6 d-flex align-items-stretch">
          ...
          <div className="map-boxed">
            <iframe
src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1998.7499477437823!2d39.2062986!3d21.3187685!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15c3b76bb2e9557b%3A0x78801707b764050c!2sSAFRA%20Co.!5e1!3m2!1sar!2ssa!4v1726235414954!5m2!1sar!2ssa"              width={600}
              height={450}
              style={{ border: 0 }}
              allowFullScreen=""
              loading="lazy"
