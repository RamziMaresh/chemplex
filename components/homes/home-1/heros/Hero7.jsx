...
export default function Hero7() {
  const strings = [
    `International Chemical Complex for Light Industries 1`,
    `International Chemical Complex for Light Industries 2`,
    `International Chemical Complex for Light Industries 3`,
  ];
